...
double IsingProp_CMCMOVE (Latt *l, double T, unsigned int seed) {
//CMCMOVE (CYCLIC).
...
double IsingProp_RMCMOVE(System *s, Latt *l, double T, unsigned int seed) {
//RMCMOVE_(RNDM).
        srand(seed);
...
double XYProp_MCMOVE(Latt *l, double T, unsigned int seed, int MPI_RANK) {
